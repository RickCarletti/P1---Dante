...
while repetindo:
    ...
    if any([x1, y1, x2, y2]):   #any(lista) testa se algum dos valores da lista é verdadeiro, se for, ele retorna verdade; Lembrando que para teste boleano de inteiro, == 0 é False e != 0 é True...
        ...
        for i in meteoro:      # itera sobre a quatidade de (pares de) cordenadas aprendidas em 'meteoro'; Nesse caso, cada par de cordenadas é uma lista dentro da lista 'meteoro', por isso i é um par valores e não um valor único...
